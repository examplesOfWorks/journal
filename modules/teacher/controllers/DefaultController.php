...
use app\models\SubjectUserSearch;
...
/**
 * DefaultController implements the CRUD actions for SubjectUser model.
 */
class DefaultController extends TeacherAppController
{
    /**
     * @inheritDoc
     */
    ...
    {
        $searchModel = new SubjectUserSearch();
        $id = Yii::$app->user->id;
        $subjectList = SubjectName::getSubjectListFromTeacher($id);
        $dataProvider = new ArrayDataProvider(['allModels' => $subjectList]);
