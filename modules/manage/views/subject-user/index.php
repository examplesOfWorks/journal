...
/** @var app\models\NewSubjectUserSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Назначение преподавателей';
...
<div class="subject-user-index">
    ...
    <div class="popular_program_area program__page">
        <div class="container">
            ...
            <p>
                <?= Html::a('Назначить преподавателя', ['create'], ['class' => 'btn btn-primary']) ?>
            </p>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($model) {
                            return $model->subjectName->title;
                        }
                    ],
                    [
                        'attribute' => 'user_id',
                    ...
                    //     'urlCreator' => function ($action, SubjectUser $model, $key, $index, $column) {
