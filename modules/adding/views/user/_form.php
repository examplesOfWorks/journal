...
<div class="user-form">
    ...
    <?= $form->field($model, 'password')->passwordInput(['placeholder' => 'Введите пароль'])->label('<span class="required">*</span>') ?>

    <?= $form->field($model, 'password_repeat')->passwordInput(['placeholder' => 'Введите пароль'])->label('<span class="required">*</span>') ?>
